# Reproduction package for "The Impossibility Spectrum of Shestoku: The Solvable Set Is Finite"
...
262-element candidate set C, the exact re-certification of all excluded values,
...
(numpy, scipy, ortools). No other dependencies. Total runtime for the full
pipeline is roughly 10-20 minutes on a modern laptop; memory use stays under
a few GB.
